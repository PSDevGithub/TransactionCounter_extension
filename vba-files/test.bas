...
Public Sub ShowHelp(control As IRibbonControl)
    ...
    message = "MUK:" & vbCrLf & _
              ...
              "    2. Rászurök az AL szlopban ('TR Type') 'Bank account'-ra és az AJ oszlop=0 (PS makes bank transfer) 'AL' oszlopban átírom a TR számot 0,5-re" & vbCrLf & _
              "    3. 'AL' oszlop ('TR type') rászurök 'DEPR'-re TR számoz átírom 0,2-re AL oszlopban."
